...
<script type="text/javascript" src="<%=path%>/js/controllers/htyhglCtrl.js" ></script>
			...
			<div class="panel-body clearfix">
				<form method="post" action="#" class="form-horizontal" role="form">
						...
						<div class="col-lg-31 clearfix">
							...
							<div class="colPart">
								<input type="text" class="input-sm form-control"
									name="nickname-query" placeholder="用户姓名">
							</div>
						</div>
						
						<div class="col-lg-31 clearfix">
							<label class="control-label labelPart">用户类型：</label>
							<div class="colPart">
								<select name="role-query">
					...
					<div class="table-responsive">
						<table class="table table-bordered gltable left">
							<thead>
								<tr>
								    <th>序号</th>
								    <th>姓名</th>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" novalidate="novalidate" id="addStaffForm">
					...
					<div class="form-group">
						...
						<div class="col-lg-61">
							...
							<div class="col-sm-81">
								<input type="text" name="nickname" class="form-control input-sm" placeholder="输入姓名">
							</div>
						</div>
						...
						<div class="col-lg-61">
							...
							<div class="col-sm-81">
								<input type="text" name="loginname" class="form-control input-sm"
									placeholder="登录帐号">
							</div>
						</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="btn_addstaff">保存</button>
			</div>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 id="myModalLabel">修改后台用户信息</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" novalidate="novalidate" id="updateStaffForm">
					...
					<div class="form-group">
						...
						<div class="col-lg-61">
							<label class="col-sm-41 control-label">联系方式：</label>
							<div class="col-sm-81">
								<input type="text" class="form-control input-sm" name="phone" placeholder="联系方式">
							</div>
						</div>
					</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
				<button type="button" class="btn btn-primary" id="btn_updatestaff">保存</button>
			</div>
		</div>
	</div>
</div>
