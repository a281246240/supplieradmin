...
%>
<script type="text/javascript" src="<%=path%>/js/controllers/xnzhjyjlCtrl.js" ></script>
	...
	<div class="container-fluid">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">虚拟账号交易记录</h3>
			</div>
				...
				<form method="post" action="#" class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-lg-31 clearfix">							
							...
							<label class="control-label labelPart">交易用途：</label>
							<div class="colPart">
						...
						<!-- 交易类别(1.订单结算2.订单扣费8.银行充值4.平台提现 128.银联支付 256.支付宝支付 512.微信支付) -->
							<label class="control-label labelPart">交易类别：</label>
							<div class="colPart">
