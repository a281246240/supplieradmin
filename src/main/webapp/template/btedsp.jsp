...
<script type="text/javascript" src="<%=path%>/js/controllers/btedspCtrl.js"></script>
<div class="glsmcxWrap">
	<div class="container-fluid">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">白条额度审批</h3>
			</div>
			<div class="panel-body clearfix">
				<form method="post" action="#" class="form-horizontal" role="form">
					...
					<div class="form-group distant"></div>
...
<!-- 回复s -->
<div class="modal fade modal-examine" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 id="myModalLabel">填写白条审核意见</h4>
			</div>
				...
				<form class="form-horizontal" novalidate="novalidate"
					...
					<div class="form-group">
						<div class="col-lg-61">
							...
							<div class="col-sm-81">
								<input readonly="readonly" name="vipname" class="form-control input-sm"/> 				
								<input type="hidden" name="id" />
								<input type="hidden" name="status" />
							</div>				
						</div>
						<div class="col-lg-61">
							<label class="col-sm-41 control-label">申请额度：</label>
							<div class="col-sm-81">
								 <input readonly="readonly" name="quota" class="form-control input-sm"/>
							</div>
					...
					<div class="form-group">
						<div class="col-lg-123 clearfix">
							<label class="col-sm-41 control-label">回复：</label>
							<div class="col-sm-81">
